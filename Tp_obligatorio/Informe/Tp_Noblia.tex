...
\draw
   (ref_gnd) to[I, l=$P_{d}$] ++(0,4)
            -- ++(2,0)   to[C=\(C_j\)] ++(0,-4) -- (ref_gnd)
            ++(2,4)   to[R=\(R_{jb}\)] ++(2.5,0) to[C=\(C_{b}\)] ++(0,-4) -- ++(-2.5,0)
            ++(2.5,4)   to[R=\(R_{bc}\)] ++(2.5,0) to[C=\(C_{c}\)] ++(0,-4) -- ++(-2.5,0)
            ++(2.5,4)   to[R=\(R_{ca}\)] ++(4.5,0) to[V=\(T_{a}\)] ++(0,-4) -- ++(-4.5,0);
